...
$frameworkFiles = @(
    ...
    @{ Src = ".tstack/version.json"; Dst = "src/.tstack/version.json"; IsDir = $false }
    @{ Src = ".github/hooks"; Dst = "src/.github/hooks"; IsDir = $true }
    @{ Src = ".tstack/scripts/pre-flight.mjs"; Dst = "src/.tstack/scripts/pre-flight.mjs"; IsDir = $false }
)
