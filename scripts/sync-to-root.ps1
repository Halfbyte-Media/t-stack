...
$frameworkFiles = @(
    ...
    @{ Src = "src/.tstack/version.json"; Dst = ".tstack/version.json"; IsDir = $false }
    @{ Src = "src/.github/hooks"; Dst = ".github/hooks"; IsDir = $true }
    @{ Src = "src/.tstack/scripts/pre-flight.mjs"; Dst = ".tstack/scripts/pre-flight.mjs"; IsDir = $false }
)
